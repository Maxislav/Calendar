    ...
    function ($compile, $templateCache, constantCalendar, $timeout, factoryPosition, serviceDaysWeek) {
        ...
        return {
            ...
            templateUrl: function(a,b){
                if (b.exact){
                    console.log(b)
                    return 'module/partials/calendar-label-exact.html'
                }else{
                    return 'module/partials/calendar-label.html'  ;
                }
            },
            scope: {
                before: '=before',
            ...
            controller: ['$scope', '$element', '$attrs', '$timeout', '$templateCache', 'serviceDaysWeek', function ($scope, $element, $attrs, $timeout, $templateCache, serviceDaysWeek) {
